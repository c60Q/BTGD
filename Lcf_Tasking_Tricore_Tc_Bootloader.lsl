...
/*--------------------------------------------------------------------------------------------------
 * Important !!!
 * Only one #define LCF_IMAGE_ can be selected at a time for opening and use.
 *--------------------------------------------------------------------------------------------------*/
#define LCF_IMAGE_BOOT 1
//#define LCF_IMAGE_APPA 1
//#define LCF_IMAGE_APPB 1
//#define LCF_IMAGE_ACTIVE_APP 1
/* Enable exactly one image macro above: BOOT for bootloader build, ACTIVE_APP for APP build. */

/*--------------------------------------------------------------------------------------------------
 * Use to choose working type, use active bank+stagingAB or direct run app on bankAB
 *--------------------------------------------------------------------------------------------------*/
#define USE_ACTIVE_BANK_MECHANISM 1

/*--------------------------------------------------------------------------------------------------
 * CPU0-only switch
 *  - LCF_CPU0_ONLY = 1 : only place CPU0 fixed start/trap vectors (default).
 *  - LCF_CPU0_ONLY = 0 : also place CPU1..CPU5 fixed start/trap vectors.
 * You can override this macro from the build (e.g. -DLCF_CPU0_ONLY=0).
 *--------------------------------------------------------------------------------------------------*/
#ifndef LCF_CPU0_ONLY
#define LCF_CPU0_ONLY 1
#endif

/*--------------------------------------------------------------------------------------------------
 * SOTA memory plan used by this file
 *  Bootloader : 0xA0000000 .. 0xA007FFFF (512 KB)
 *  Application: 0xA0080000 .. 0xA037FFFF (3 MB)
 *  Staging A  : 0xA0380000 .. 0xA067FFFF (3 MB)
 *  Staging B  : 0xA0680000 .. 0xA097FFFF (3 MB)
 *  Application header reserves the first 16 KB of the Application slot.
 *  BCB reserves one 4 KB DFLASH0 sector at 0xAF0FE000.
 *--------------------------------------------------------------------------------------------------*/
...
#if defined(LCF_IMAGE_BOOT)
#define LCF_INTVEC0_START 0xA0072000
#define LCF_INTVEC1_START 0xA0074000
#define LCF_INTVEC2_START 0xA0076000
#define LCF_INTVEC3_START 0xA0078000
#define LCF_INTVEC4_START 0xA007A000
#define LCF_INTVEC5_START 0xA007C000
#define LCF_TRAPVEC0_START 0xA0000100
#define LCF_TRAPVEC1_START 0xA0000200
#define LCF_TRAPVEC2_START 0xA0000300
#define LCF_TRAPVEC3_START 0xA0000400
#define LCF_TRAPVEC4_START 0xA0000500
#define LCF_TRAPVEC5_START 0xA0000600
#define LCF_STARTPTR_CPU0 0x80000000
#define LCF_STARTPTR_CPU1 0x80004200
#define LCF_STARTPTR_CPU2 0x80004400
#define LCF_STARTPTR_CPU3 0x80004600
#define LCF_STARTPTR_CPU4 0x80004800
#define LCF_STARTPTR_CPU5 0x80004A00
#define LCF_STARTPTR_NC_CPU0 0xA0000000
#define LCF_STARTPTR_NC_CPU1 0xA0004200
#define LCF_STARTPTR_NC_CPU2 0xA0004400
#define LCF_STARTPTR_NC_CPU3 0xA0004600
#define LCF_STARTPTR_NC_CPU4 0xA0004800
#define LCF_STARTPTR_NC_CPU5 0xA0004A00
#elif defined(LCF_IMAGE_ACTIVE_APP)
#define LCF_INTVEC0_START 0xA0372000
#define LCF_INTVEC1_START 0xA0374000
#define LCF_INTVEC2_START 0xA0376000
#define LCF_INTVEC3_START 0xA0378000
#define LCF_INTVEC4_START 0xA037A000
#define LCF_INTVEC5_START 0xA037C000
#define LCF_TRAPVEC0_START 0xA0084B00
#define LCF_TRAPVEC1_START 0xA0084C00
#define LCF_TRAPVEC2_START 0xA0084D00
#define LCF_TRAPVEC3_START 0xA0084E00
#define LCF_TRAPVEC4_START 0xA0084F00
#define LCF_TRAPVEC5_START 0xA0085000
#define LCF_STARTPTR_CPU0 0x80084000
#define LCF_STARTPTR_CPU1 0x80084180
#define LCF_STARTPTR_CPU2 0x80084360
#define LCF_STARTPTR_CPU3 0x80084540
#define LCF_STARTPTR_CPU4 0x80084700
#define LCF_STARTPTR_CPU5 0x800848C0
#define LCF_STARTPTR_NC_CPU0 0xA0084000
#define LCF_STARTPTR_NC_CPU1 0xA0084180
#define LCF_STARTPTR_NC_CPU2 0xA0084360
#define LCF_STARTPTR_NC_CPU3 0xA0084540
#define LCF_STARTPTR_NC_CPU4 0xA0084700
#define LCF_STARTPTR_NC_CPU5 0xA00848C0
#else
...
derivative tc39
{
    ...
    memory pfls0
    {
        ...
        /* map not_cached (dest=bus:sri, dest_offset=0xa0000000, reserved, size=3M); */ /* disabled: overlaps with sota_* windows */
    }
    ...
    memory pfls1
    {
        ...
        /* map not_cached (dest=bus:sri, dest_offset=0xa0300000, reserved, size=3M); */ /* disabled: overlaps with sota_* windows */
    }
    ...
    memory pfls2
    {
        ...
        /* map not_cached (dest=bus:sri, dest_offset=0xa0600000, reserved, size=3M); */ /* disabled: overlaps with sota_* windows */
    }
    ...
    memory pfls3
    {
        ...
        /* map not_cached (dest=bus:sri, dest_offset=0xa0900000, reserved, size=3M); */ /* disabled: overlaps with sota_* windows */
...
/* ===== SOTA logical windows (added; keep original pfls/dfls/ucb intact) ===== */
memory sota_boot_pflash
{
    mau = 8; size = 512k; type = rom;
    map (dest=bus:sri, dest_offset=0xA0000000, size=512k);   /* Boot 512 KB */
}

#if defined(USE_ACTIVE_BANK_MECHANISM)
memory sota_active_app_pflash
{
    mau = 8; size = 3M; type = rom;
    map (dest=bus:sri, dest_offset=0xA0080000, size=3M);     /* Application 3 MB */
}

memory sota_appA_pflash
{
    mau = 8; size = 3M; type = rom;
    map (dest=bus:sri, dest_offset=0xA0380000, size=3M);     /* Staging A 3 MB */
}

memory sota_appB_pflash
{
    mau = 8; size = 3M; type = rom;
    map (dest=bus:sri, dest_offset=0xA0680000, size=3M);     /* Staging B 3 MB */
}

#if defined(LCF_IMAGE_ACTIVE_APP)
/* In ACTIVE_APP mode, keep RAM run_addr groups pure RAM placements.
 * ROM copy sections are collected explicitly in active_app_rom_copy. */
#define LCF_ACTIVE_APP_INITROM_ATTR
#else
#define LCF_ACTIVE_APP_INITROM_ATTR
#endif
...
{
    mau = 8; size = 3M; type = rom;
    map (dest=bus:sri, dest_offset=0xA0080000, size=3M);     /* AppA 3 MB */
}

memory sota_appB_pflash
{
    mau = 8; size = 3M; type = rom;
    map (dest=bus:sri, dest_offset=0xA0380000, size=3M);     /* AppB 3 MB */
}
#endif
section_layout :vtc:linear
    {
        ...
        group (ordered)
        {
            group  reset (run_addr=RESET)
            {
                ...
                {
#if !defined(LCF_IMAGE_BOOT) && !defined(LCF_IMAGE_APPA) && !defined(LCF_IMAGE_APPB) && !defined(LCF_IMAGE_ACTIVE_APP)
        select ".text.start";
	select ".text.cstart";
#endif
                }
...
#if !defined(LCF_IMAGE_BOOT) && !defined(LCF_IMAGE_ACTIVE_APP)
...
#                include "inttab5.lsl"
    ...
    section_layout :vtc:abs18
    {
        ...
        group
        {
            group (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram5 LCF_ACTIVE_APP_INITROM_ATTR)
            {
                select "(.zdata.zdata_cpu5|.zdata.zdata_cpu5.*)";
                select "(.zbss.zbss_cpu5|.zbss.zbss_cpu5.*)";
            }
            
            group (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram4 LCF_ACTIVE_APP_INITROM_ATTR)
            {
                select "(.zdata.zdata_cpu4|.zdata.zdata_cpu4.*)";
                select "(.zbss.zbss_cpu4|.zbss.zbss_cpu4.*)";
            }
            
            group (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram3 LCF_ACTIVE_APP_INITROM_ATTR)
            {
                select "(.zdata.zdata_cpu3|.zdata.zdata_cpu3.*)";
                select "(.zbss.zbss_cpu3|.zbss.zbss_cpu3.*)";
            }
            
            group (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram2 LCF_ACTIVE_APP_INITROM_ATTR)
            {
                select "(.zdata.zdata_cpu2|.zdata.zdata_cpu2.*)";
                select "(.zbss.zbss_cpu2|.zbss.zbss_cpu2.*)";
            }
            
            group (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram1 LCF_ACTIVE_APP_INITROM_ATTR)
            {
                select "(.zdata.zdata_cpu1|.zdata.zdata_cpu1.*)";
                select "(.zbss.zbss_cpu1|.zbss.zbss_cpu1.*)";
            }
            
            group (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram0 LCF_ACTIVE_APP_INITROM_ATTR)
            {
                select "(.zdata.zdata_cpu0|.zdata.zdata_cpu0.*)";
                select "(.zbss.zbss_cpu0|.zbss.zbss_cpu0.*)";
            }
            
            group (ordered, attributes=rw, run_addr = mem:cpu0_dlmu LCF_ACTIVE_APP_INITROM_ATTR)
            {
...
#        if LCF_DEFAULT_HOST == LCF_CPU5
        group a0 (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram5 LCF_ACTIVE_APP_INITROM_ATTR)
#        endif
#        if LCF_DEFAULT_HOST == LCF_CPU4
        group a0 (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram4 LCF_ACTIVE_APP_INITROM_ATTR)
#        endif
#        if LCF_DEFAULT_HOST == LCF_CPU3
        group a0 (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram3 LCF_ACTIVE_APP_INITROM_ATTR)
#        endif
#        if LCF_DEFAULT_HOST == LCF_CPU2
        group a0 (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram2 LCF_ACTIVE_APP_INITROM_ATTR)
#        endif
#        if LCF_DEFAULT_HOST == LCF_CPU1
        group a0 (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram1 LCF_ACTIVE_APP_INITROM_ATTR)
#        endif
#        if LCF_DEFAULT_HOST == LCF_CPU0
        group a0 (ordered, contiguous, align = 4, attributes=rw, run_addr = mem:dsram0 LCF_ACTIVE_APP_INITROM_ATTR)
#        endif
        {
...
#        endif
    ...
    section_layout :vtc:linear
    {
        ...
        group
        {
            ...
            group
            {
                group (ordered, attributes=rw, run_addr=mem:dsram5 LCF_ACTIVE_APP_INITROM_ATTR)
                {
                ...
                group (ordered, attributes=rw, run_addr=mem:dsram4 LCF_ACTIVE_APP_INITROM_ATTR)
                {
                ...
                group (ordered, attributes=rw, run_addr=mem:dsram3 LCF_ACTIVE_APP_INITROM_ATTR)
                {
                ...
                group (ordered, attributes=rw, run_addr=mem:dsram2 LCF_ACTIVE_APP_INITROM_ATTR)
                {
                ...
                group (ordered, attributes=rw, run_addr=mem:dsram1 LCF_ACTIVE_APP_INITROM_ATTR)
                {
                ...
                group (ordered, attributes=rw, run_addr=mem:dsram0 LCF_ACTIVE_APP_INITROM_ATTR)
                {
            ...
            group
            {
                ...
                group (ordered, attributes=rw, run_addr = mem:cpu1_dlmu LCF_ACTIVE_APP_INITROM_ATTR)
                {
                    select "(.data.lmudata_cpu1|.data.lmudata_cpu1.*)";
                    select "(.bss.lmubss_cpu1|.bss.lmubss_cpu1.*)";
                }
                group (ordered, attributes=rw, run_addr = mem:cpu2_dlmu LCF_ACTIVE_APP_INITROM_ATTR)
                {
                    select "(.data.lmudata_cpu2|.data.lmudata_cpu2.*)";
                    select "(.bss.lmubss_cpu2|.bss.lmubss_cpu2.*)";
                }
                group (ordered, attributes=rw, run_addr = mem:cpu3_dlmu LCF_ACTIVE_APP_INITROM_ATTR)
                {
                    select "(.data.lmudata_cpu3|.data.lmudata_cpu3.*)";
                    select "(.bss.lmubss_cpu3|.bss.lmubss_cpu3.*)";
                }
                group (ordered, attributes=rw, run_addr = mem:cpu4_dlmu LCF_ACTIVE_APP_INITROM_ATTR)
                {
                    select "(.data.lmudata_cpu4|.data.lmudata_cpu4.*)";
                    select "(.bss.lmubss_cpu4|.bss.lmubss_cpu4.*)";
                }
                group (ordered, attributes=rw, run_addr = mem:cpu5_dlmu LCF_ACTIVE_APP_INITROM_ATTR)
                {
...
#        endif
	...
	/* ===== SOTA images (select ONE via -DLCF_IMAGE_BOOT/APPA/APPB) ===== */
	section_layout :vtc:linear
	{
	# if defined(LCF_IMAGE_BOOT)
		/* Boot image @ 0xA0000000, keep CPU0/1..5 start+trap code inside Bootloader window. */
		group boot_image (ordered, run_addr = mem:sota_boot_pflash[0x20])
		{
			group boot_entry (ordered, align = 32)
			{
				select ".text.start";
				select ".text.cstart";
			}
			group boot_core0_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc0.__Core0_start";
			}
			group boot_core1_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc1.__Core1_start";
			}
			group boot_core2_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc2.__Core2_start";
			}
			group boot_core3_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc3.__Core3_start";
			}
			group boot_core4_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc4.__Core4_start";
			}
			group boot_core5_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc5.__Core5_start";
			}
			group boot_trapvec_tc0 (ordered, align = 256)
			{
				select "(.text.traptab_cpu0*)";
			}
			group boot_trapvec_tc1 (ordered, align = 256)
			{
				select "(.text.traptab_cpu1*)";
			}
			group boot_trapvec_tc2 (ordered, align = 256)
			{
				select "(.text.traptab_cpu2*)";
			}
			group boot_trapvec_tc3 (ordered, align = 256)
			{
				select "(.text.traptab_cpu3*)";
			}
			group boot_trapvec_tc4 (ordered, align = 256)
			{
				select "(.text.traptab_cpu4*)";
			}
			group boot_trapvec_tc5 (ordered, align = 256)
			{
				select "(.text.traptab_cpu5*)";
			}
			select "table";
			...
			select ".fini_array*";
			select ".eh_frame*";
			select ".gcc_except_table*";
		}
		group boot_rom_copy (ordered, align = 4, run_addr = mem:sota_boot_pflash[0x68000])
		{
			/* Keep ROM-copy/load-image content inside Bootloader slot, not cached alias 0x800... */
			select "\[.data\]";
			select "\[.data.*\]";
			select "\[.zdata\]";
			select "\[.zdata.*\]";
			select "\[.data_a0.sdata\]";
			select "\[.data_a0.sdata.*\]";
			select "\[.data_a9.a9sdata\]";
			select "\[.data_a9.a9sdata.*\]";
			select "\[.text.cpu0_psram\]";
			select "\[.text.cpu0_psram.*\]";
			select "\[.text.psram_text_cpu0\]";
			select "\[.text.psram_text_cpu0.*\]";
			select "\[.text.cpu1_psram\]";
			select "\[.text.cpu1_psram.*\]";
			select "\[.text.psram_text_cpu1\]";
			select "\[.text.psram_text_cpu1.*\]";
			select "\[.text.cpu2_psram\]";
			select "\[.text.cpu2_psram.*\]";
			select "\[.text.psram_text_cpu2\]";
			select "\[.text.psram_text_cpu2.*\]";
			select "\[.text.cpu3_psram\]";
			select "\[.text.cpu3_psram.*\]";
			select "\[.text.psram_text_cpu3\]";
			select "\[.text.psram_text_cpu3.*\]";
			select "\[.text.cpu4_psram\]";
			select "\[.text.cpu4_psram.*\]";
			select "\[.text.psram_text_cpu4\]";
			select "\[.text.psram_text_cpu4.*\]";
			select "\[.text.cpu5_psram\]";
			select "\[.text.cpu5_psram.*\]";
			select "\[.text.psram_text_cpu5\]";
			select "\[.text.psram_text_cpu5.*\]";
		}
		"__START1" := addressof(group:boot_core1_start);
		"__START2" := addressof(group:boot_core2_start);
		"__START3" := addressof(group:boot_core3_start);
		"__START4" := addressof(group:boot_core4_start);
		"__START5" := addressof(group:boot_core5_start);
		"__TRAPTAB_CPU0" := addressof(group:boot_trapvec_tc0);
		"__TRAPTAB_CPU1" := addressof(group:boot_trapvec_tc1);
		"__TRAPTAB_CPU2" := addressof(group:boot_trapvec_tc2);
		"__TRAPTAB_CPU3" := addressof(group:boot_trapvec_tc3);
		"__TRAPTAB_CPU4" := addressof(group:boot_trapvec_tc4);
		"__TRAPTAB_CPU5" := addressof(group:boot_trapvec_tc5);
	# endif

	#if defined(USE_ACTIVE_BANK_MECHANISM)
	# if defined(LCF_IMAGE_ACTIVE_APP)
		/* Active App header @ +0x0, reserve full first 16KB sector for header/update metadata */
		group active_app_header (ordered, align = 32, run_addr = mem:sota_active_app_pflash[0x0])
		{
			select ".active_app_header";
		}
		group active_app_header_pad (ordered, run_addr = mem:sota_active_app_pflash[0x40])
		{
			reserved "ACTIVE_APP_HEADER_PAD" (size = 0x3FC0);
		}
		/* Active App payload @ +0x4000 (first 16KB sector reserved for header) */
		group active_app_image (ordered, run_addr = mem:sota_active_app_pflash[0x4000])
		{
			group active_app_entry (ordered, align = 32)
			{
				select ".text.start";
				select ".text.cstart";
			}
			group active_app_core0_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc0.__Core0_start";
			}
			group active_app_core1_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc1.__Core1_start";
			}
			group active_app_core2_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc2.__Core2_start";
			}
			group active_app_core3_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc3.__Core3_start";
			}
			group active_app_core4_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc4.__Core4_start";
			}
			group active_app_core5_start (ordered, align = 32)
			{
				select ".text.Ifx_Ssw_Tc5.__Core5_start";
			}
			group active_app_trapvec_tc0 (ordered, align = 256)
			{
				select "(.text.traptab_cpu0*)";
			}
			group active_app_trapvec_tc1 (ordered, align = 256)
			{
				select "(.text.traptab_cpu1*)";
			}
			group active_app_trapvec_tc2 (ordered, align = 256)
			{
				select "(.text.traptab_cpu2*)";
			}
			group active_app_trapvec_tc3 (ordered, align = 256)
			{
				select "(.text.traptab_cpu3*)";
			}
			group active_app_trapvec_tc4 (ordered, align = 256)
			{
				select "(.text.traptab_cpu4*)";
			}
			group active_app_trapvec_tc5 (ordered, align = 256)
			{
				select "(.text.traptab_cpu5*)";
			}
			group active_app_a1 (ordered, align = 4)
			{
				select "(.rodata_a1.srodata|.rodata_a1.srodata.*)";
				select "(.ldata|.ldata.*)";
			}
			group active_app_a8 (ordered, align = 4)
			{
				select "(.rodata_a8.a8srodata|.rodata_a8.a8srodata.*)";
			}
			select "table";
		...
		group active_app_rom_copy (ordered, align = 4, run_addr = mem:sota_active_app_pflash[0x2F0000])
		{
			/* Dedicated ROM-copy placement for initialized RAM data, kept inside Application slot. */
			select "\[.data\]";
			select "\[.data.*\]";
			select "\[.zdata\]";
			select "\[.zdata.*\]";
		...
		"__START0" := addressof(group:active_app_entry);
		"__START1" := addressof(group:active_app_core1_start);
		"__START2" := addressof(group:active_app_core2_start);
		"__START3" := addressof(group:active_app_core3_start);
		"__START4" := addressof(group:active_app_core4_start);
		"__START5" := addressof(group:active_app_core5_start);
		"__TRAPTAB_CPU0" := addressof(group:active_app_trapvec_tc0);
		"__TRAPTAB_CPU1" := addressof(group:active_app_trapvec_tc1);
		"__TRAPTAB_CPU2" := addressof(group:active_app_trapvec_tc2);
		"__TRAPTAB_CPU3" := addressof(group:active_app_trapvec_tc3);
		"__TRAPTAB_CPU4" := addressof(group:active_app_trapvec_tc4);
		"__TRAPTAB_CPU5" := addressof(group:active_app_trapvec_tc5);
		"_LITERAL_DATA_" := sizeof(group:active_app_a1) > 0 ? addressof(group:active_app_a1) : addressof(group:active_app_image) & 0xF0000000 + 32k;
		"__A1_MEM" = "_LITERAL_DATA_";
		"_A8_DATA_" := sizeof(group:active_app_a8) > 0 ? addressof(group:active_app_a8) : addressof(group:active_app_image) & 0xF0000000 + 32k;
		"__A8_MEM" = "_A8_DATA_";
		"_lc_u_int_tab"  = (LCF_INTVEC0_START);
		"__INTTAB_CPU0"  = (LCF_INTVEC0_START);
		"__INTTAB_CPU1"  = (LCF_INTVEC1_START);
	...
	#else
	# if defined(LCF_IMAGE_APPA)
		/* AppA header @ +0x0, reserve full first 16KB sector for header/update metadata */
		group appa_header (ordered, align = 32, run_addr = mem:sota_appA_pflash[0x0])
		{
			select ".app_a_header";
		}
		group appa_header_pad (ordered, run_addr = mem:sota_appA_pflash[0x40])
		{
			reserved "APPA_HEADER_PAD" (size = 0x3FC0);
		}
		/* AppA body @ +0x4000 */
		group appa_image (ordered, run_addr = mem:sota_appA_pflash[0x4000])
		{
			select ".text.start";
			select ".text.cstart";
			select ".text.traptab*";
	...
	# if defined(LCF_IMAGE_APPB)
		/* AppB header @ +0x0, reserve full first 16KB sector for header/update metadata */
		group appb_header (ordered, align = 32, run_addr = mem:sota_appB_pflash[0x0])
		{
			select ".app_b_header";
		}
		group appb_header_pad (ordered, run_addr = mem:sota_appB_pflash[0x40])
		{
			reserved "APPB_HEADER_PAD" (size = 0x3FC0);
		}
		/* AppB body @ +0x4000 */
		group appb_image (ordered, run_addr = mem:sota_appB_pflash[0x4000])
		{
			select ".text.start";
			select ".text.cstart";
			select ".text.traptab*";
	...
	/* BCB reserved sector: reserve full 4KB DFLASH logical sector to prevent accidental use by other sections. */
	group BCB_RESERVED_GROUP (ordered, align = 8, run_addr = mem:dfls0[0x000FE000])
	{
		reserved "BCB_RESERVED" (size = 4k);
	}
	}
}