...
extern boot_int8u NvmWriteHook(boot_addr addr, boot_int32u len, boot_int8u *data);
extern boot_int8u NvmEraseHook(boot_addr addr, boot_int32u len);
extern boot_bool  NvmDoneHook(void);
#endif

#if (BOOT_NVM_CHECKSUM_HOOKS_ENABLE > 0)
extern boot_bool  NvmWriteChecksumHook(void);
extern boot_bool  NvmVerifyChecksumHook(void);
#endif
...
**
****************************************************************************************/
boot_bool NvmWrite(boot_addr addr, boot_int32u len, boot_int8u *data)
{
#if (BOOT_NVM_HOOKS_ENABLE > 0)
  boot_int8u result = BLT_NVM_NOT_IN_RANGE;
#endif
...
**
****************************************************************************************/
boot_bool NvmErase(boot_addr addr, boot_int32u len)
{
#if (BOOT_NVM_HOOKS_ENABLE > 0)
  boot_int8u result = BLT_NVM_NOT_IN_RANGE;
#endif
...
**
****************************************************************************************/
boot_bool NvmVerifyChecksum(void)
{
#if (BOOT_NVM_CHECKSUM_HOOKS_ENABLE > 0)
...
**
****************************************************************************************/
boot_addr NvmGetUserProgBaseAddress(void)
{
...
boot_bool NvmDone(void)
{
  ...
  if (NvmWriteChecksumHook() == boot_FALSE)
  {
    return boot_FALSE;
  }
#else
  /* compute and write checksum, which is programmed by the internal driver. */
  if (FlashWriteChecksum() == boot_FALSE)
  {
    return boot_FALSE;
  }
#endif
